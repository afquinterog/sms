  ...
  role="navigation">
    <div class="navbar-header">
      ...
      <a class="navbar-brand navbar-brand-center" href="/">
        <img class="navbar-brand-logo navbar-brand-logo-normal" src="{{ url('assets/images/logo.png') }}"
        title="OruServices">

        <img class="navbar-brand-logo navbar-brand-logo-special" src="{{ url('assets/images/logo-blue.png') }}"
        title="OruServices">
